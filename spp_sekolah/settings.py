"""
Django settings for spp_sekolah project.
...
WSGI_APPLICATION = 'spp_sekolah.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config (
        default='sqlite:///db.sqlite3', #production
...
# Mengarahkan pengguna ke URL root (/) setelah login berhasil
LOGIN_REDIRECT_URL = '/'
